...
test_results$logit <- ifelse(test_results$logit > 0.7, "No", "Yes") %>% factor(c("Yes", "No"), levels = c("Yes", "No"))
confusionMatrix(test_results$logit, test_results$test)
```
...
test_results$trees <- ifelse(test_results$trees > 0.8, "No", "Yes") %>% factor(c("Yes", "No"), levels = c("Yes", "No"))
confusionMatrix(test_results$trees, test_results$test)
```
...
test_results$rf <- ifelse(test_results$rf > 0.6, "No", "Yes") %>% factor(c("Yes", "No"), levels = c("Yes", "No"))
confusionMatrix(test_results$rf, test_results$test)
```
