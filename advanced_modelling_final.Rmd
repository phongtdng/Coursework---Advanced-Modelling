...
```{r}
nn <- train(nightly_rate_usd ~ hotel_stars + amenities + agency_cancellation + hotel_cancellation + leadtime + hotel_latitude + hotel_longitude + free_breakfast + bed_type + bed_number , # Removed some features with many levels
            data = regTrain,
            method = "neuralnet",
            trControl = ctrl,
            preProcess = c("nzv"),
