...
clean_data <- booking_data %>% 
  ...
  mutate(across(c(added_date, modified_date, created_date, check_in, check_out, cancel_date), as.Date),
         across(c(booking_source, hotel_chain_name, start_commission_info, start_cancel_policy, start_rate_type, start_room_type, start_bed_type, start_amenities),as.factor)) %>% 
