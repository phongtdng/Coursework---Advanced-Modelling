...
This data set is a sample data set obtained from Nasdaq Data Link. The dataset contains hotel bookings processed through global corporate travel and expense agencies. More information about the dataset can be obtained from Nasdaq Data Link ([Nasdaq, n.d.](https://data.nasdaq.com/databases/CHB#anchor-coverage)).
